...
using TalabeyahTaskApi.Application.Common.Mailing;
using TalabeyahTaskApi.Application.Identity;
using TalabeyahTaskApi.Application.Identity.Users;
using TalabeyahTaskApi.Domain.Common;
using TalabeyahTaskApi.Domain.Identity;
...
internal partial class UserService
{
    ...
    public async Task<string> CreateAsync(CreateUserRequest request, string origin)
    {
        ...
        {
            await _userManager.AddToRoleAsync(user, FSHRoles.Applicant);
        }
        else if (user.Type == UserType.Employer)
        {
            await _userManager.AddToRoleAsync(user, FSHRoles.Employer);
        }
