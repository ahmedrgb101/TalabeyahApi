...
using TalabeyahTaskApi.Application.Identity.Tokens;
using TalabeyahTaskApi.Application.Identity.Users;
using TalabeyahTaskApi.Infrastructure.Auth;
using TalabeyahTaskApi.Infrastructure.Auth.Jwt;
using TalabeyahTaskApi.Infrastructure.Mailing;
...
internal class TokenService : ITokenService
{
    ...
    public async Task<TokenResponse> GetTokenAsync(TokenRequest request, string ipAddress, CancellationToken cancellationToken)
    {
        ...
        return await GenerateTokensAndUpdateUser(user, ipAddress, cancellationToken);
    }
    ...
    private async Task<TokenResponse> GenerateTokensAndUpdateUser(ApplicationUser user, string ipAddress, CancellationToken cancellationToken = default)
    {
        ...
        return new TokenResponse(token, user.RefreshToken, permissions, userRoles, user.RefreshTokenExpiryTime);
    }
