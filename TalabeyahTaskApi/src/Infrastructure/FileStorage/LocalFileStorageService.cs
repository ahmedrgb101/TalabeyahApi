using TalabeyahTaskApi.Application.Common.FileStorage;
using TalabeyahTaskApi.Domain.Common;
using TalabeyahTaskApi.Infrastructure.Common.Extensions;
using System.Runtime.InteropServices;
using System.Text.RegularExpressions;

namespace TalabeyahTaskApi.Infrastructure.FileStorage;
public class LocalFileStorageService : IFileStorageService
{
    ...
    where T : class
    {
        ...
        else if (supportedFileType == FileType.File)
            base64Data = request.Data.Replace("data:application/octet-stream;base64,",string.Empty);
        ...
        if (streamData.Length > 0)
        {
            ...
            string folderName = supportedFileType switch
            {
                ...
                FileType.File => Path.Combine("Files", "Docs", folder),
