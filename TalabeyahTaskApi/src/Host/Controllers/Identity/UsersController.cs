...
namespace TalabeyahTaskApi.Host.Controllers.Identity;
public class UsersController : VersionNeutralApiController
{
    ...
    [HttpGet("SearchUsersListAsync")]
    [MustHavePermission(FSHAction.View, FSHResource.Users)]
    [OpenApiOperation("Search list of all users.", "")]
    public Task<List<UserDetailsDto>> SearchUsersListAsync(CancellationToken cancellationToken, string? value)
    {
        return _userService.SearchUsersListAsync(cancellationToken, value);
    }
